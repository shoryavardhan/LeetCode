...
class Solution {
    ...
    public void bfs(char[][] grid, Queue<Pair<Integer, Integer>> q,
            HashSet<Pair<Integer, Integer>> set, int i, int j) {
    ...
    private void addNeighbor(Queue<Pair<Integer, Integer>> q,
            HashSet<Pair<Integer, Integer>> set, int newX, int newY,
